...
<div id="profileServerTabs">
	<ul>
		{$tabs = [activity, comments]}
		
		<li><a href="{devblocks_url}ajax.php?c=internal&a=showTabActivityLog&scope=target&point={$point}&context=cerberusweb.contexts.datacenter.server&context_id={$page_context_id}{/devblocks_url}">{'common.log'|devblocks_translate|capitalize}</a></li>   
...
$(function() {
	...
	tabOptions.active = Devblocks.getjQueryUiTabSelected('profileServerTabs');
	
	var tabs = $("#profileServerTabs").tabs(tabOptions);
	
	// Edit
	
	$('#btnDatacenterServerEdit')
		.cerbPeekTrigger()
